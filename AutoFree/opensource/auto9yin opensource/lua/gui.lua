...
local gui_close_allsystem_value = 0
...
function gui_size(gui, width, height)
  ...
  nx_execute("form_stage_main\\form_chat_system\\form_chat_group", "change_form_size")
...
function gui_close_allsystem_form(closetype)
  local gui = nx_value("gui")
  gui_close_allsystem_value = gui_close_allsystem_value + 1
  if gui_close_allsystem_value > 1 then
    return
  end
...
function gui_open_closedsystem_form()
  gui_close_allsystem_value = gui_close_allsystem_value - 1
  if gui_close_allsystem_value > 0 then
    return
  end
