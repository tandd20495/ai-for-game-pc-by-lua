...
local THIS_FORM = "auto_new\\form_auto_buymarket"
    ...
    while auto_is_running == true do
        ...
        if nx_is_valid(form) then
            ...
            if nx_is_valid(formMarket) then
                ...
                showUtf8Text(AUTO_LOG_BUY_SHOP1, 3)
                set_stop()
                return false
            end
...
function set_stop()
    ...
    btn.Text = nx_function("ext_utf8_to_widestr", AUTO_LOG_BUY_SHOP2)
end
...
function set_start()
    ...
    local btn = form.btn_control
    btn.Text = nx_function("ext_utf8_to_widestr", AUTO_LOG_BUY_SHOP3)
end
