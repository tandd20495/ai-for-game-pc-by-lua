...
function auto_run_dynamic()
    ...
    while auto_is_running_dynamic == true do
		...
		nx_execute("admin_yBreaker\\yBreaker_admin_libraries\\yBreaker_event_manager", "TriggerEvent", nx_current(), "on-task-interrupt")
...
function Start()
	...
	start_type_dynamic()
	--nx_execute("admin_yBreaker\\yBreaker_admin_libraries\\yBreaker_event_manager", "Subscribe", Logic, "on-task-stop", nx_current(), "onTaskStop")
end
