...
function IniReadTextSection(file)
  file = nx_resource_path() .. "yBreaker\\text\\" .. file .. ".ini"
...
function Console(text)
  local form = nx_value("admin_yBreaker\\form_log")
  if nx_is_valid(form) then
    nx_execute("admin_yBreaker\\form_log", "Log", text)
  end
end
-- for debug
